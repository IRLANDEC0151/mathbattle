const FastMatch = {
    ...
    answerCounter(randomArifmSign) {
        ...
        this.example = `${firstParam.textContent} ${randomArifmSign} ${secondParam.textContent}`;
        this.answer = eval(
...
function submitStatistic(){
    ...
    document.querySelector('.percentageOfCorrectAnswers').value=FastMatch.percentageOfCorrectAnswers
    document.querySelector('.timeMiddleExample') .value=FastMatch.timeMiddleExample 
    form.submit()
}
